...
%					E.g. { 'Dy1 == k1 * x + y1 * ( y2 + k2 )' , 'v2 == k2 * y1 + y2 - k1' } (where Dy1 represents for dy1/dx, v2 represents for dy2/dx)
%
%		var_list: 	list of variables, has to be symbolic, helps to differe variables from coefficients.
%					E.g. { 'y1' , 'y2' , 'x' }
...
%
%		coef_list:	name of coefficients, helps to differe coefficients from variables.
%					E.g. { 'k1' , 'k2' }
%
%		coef_ini:	initial guess for the value of coefficients, not essential, but will help to reach the best fitting value faster.
%					E.g. [ k1_val , k2_val ]
%
%		der_list:		list of derivatives, must be in the same order of var_list.
%					E.g. { 'Dy1' , 'v2' }
%
%		region:		region for the independent variable, helps the ode solver to identify its' solving interval.
%					E.g. [ x_min , x_max ] 
%
%		NAME:		name of measured variables. At least two terms should be measured in the experiment.
...
%					E.g. 'SA_CHANGE', 0.01		-- sets the maxium range for coefficient changings to 0.01
%
%--------------------------------------------------------------------------------------------------------------------------------------------------
%
%	Outputs:
%
%		coef:		fitting results for the coefficients.
